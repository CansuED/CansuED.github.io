...
<div class="lab-about-container">
  ...
  <div class="lab-about-header">
    <p class="lab-tagline">Harnessing <strong>D</strong>igital, <strong>D</strong>ata, <strong>D</strong>esign, and <strong>D</strong>evelopment to build Sustainable Futures</p>
  </div>

  <div class="lab-about-content">
    ...
    <div class="research-section">
      ...
      <p>We combine rigorous research methods with practical applications to address real-world challenges at the intersection of technology and social impact.</p>
    </div>

    <div class="collaboration-section">
      <p><strong>Partnerships Welcome:</strong> We actively seek collaborations with government agencies, international organizations, non-profits, social service providers, and community groups eager to leverage technology in building equitable and resilient futures.</p>
    </div>
